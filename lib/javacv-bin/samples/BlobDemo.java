...
public class BlobDemo {
    ...
    public static void demo() {
        ...
        for (int k = 0; k < 7; k++) {
            if (k == 0) {
                RawImage = cvLoadImage("Images/BlackBalls.jpg");
                MinArea = 250;
                ErodeCount = 0;
                DilateCount = 1;
            } else if (k == 1) {
                RawImage = cvLoadImage("Images/Shapes1.jpg");
                MinArea = 6;
                ErodeCount = 0;
                DilateCount = 1;
            } else if (k == 2) {
                RawImage = cvLoadImage("Images/Shapes2.jpg");
                MinArea = 250;
                ErodeCount = 0;
                DilateCount = 1;
            } else if (k == 3) {
                RawImage = cvLoadImage("Images/Blob1.jpg");
                MinArea = 2800;
                ErodeCount = 1;
                DilateCount = 1;
            } else if (k == 4) {
                RawImage = cvLoadImage("Images/Blob2.jpg");
                MinArea = 2800;
                ErodeCount = 1;
                DilateCount = 1;
            } else if (k == 5) {
                RawImage = cvLoadImage("Images/Blob3.jpg");
                MinArea = 2800;
                ErodeCount = 1;
                DilateCount = 1;
            } else if (k == 6) {
                RawImage = cvLoadImage("Images/Rice.jpg");
                MinArea = 30;
                ErodeCount = 2;
                DilateCount = 1;
            }
